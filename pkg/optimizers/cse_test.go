...
var cseCases = map[string]string{
	...
	`foo=:long+:long bar=:long+:long`:           `_tmp0=:long foo=_tmp0+_tmp0 bar=foo`,
	`foo=:long+:long bar=:long+:long baz=:long`: `_tmp0=:long foo=_tmp0+_tmp0 bar=foo baz=_tmp0`,
	`foo=:long bar=:long+:long baz=:long+:long`: `foo=:long bar=foo+foo baz=bar`,
}
